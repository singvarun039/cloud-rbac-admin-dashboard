...
// Renders a submenu trigger inside a dropdown menu.
...
// Renders submenu content inside a dropdown menu.
...
// Renders the main dropdown menu content surface.
...
// Renders a clickable dropdown menu item.
...
// Renders a checkbox item inside a dropdown menu.
...
// Renders a radio item inside a dropdown menu.
...
// Renders a section label inside a dropdown menu.
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-xs font-medium text-slate-700', inset ? 'pl-8' : '', className)}
    {...props}
  />
));
...
// Renders shortcut text aligned to the end of a dropdown item.
