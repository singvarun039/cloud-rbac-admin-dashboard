...
// Renders the alert dialog surface.
...
// Renders the alert dialog footer actions layout.
...
// Renders the alert dialog description text.
...
// Renders the cancel button inside an alert dialog.
