...
export function useAuditLogsPage() {
  ...
  const query = useMemo<GetAuditLogsParams>(
    ...
    [
      actionApplied, actorEmailApplied, actorUserIdApplied,
      dateFromApplied, dateToApplied, entityIdApplied,
      entityTypeApplied, limit, page, requestIdApplied,
    ]
  );
  ...
  const onApplyFilters = useCallback(() => {
    ...
    actionInput, actorEmailInput, actorUserIdInput,
    dateFromInput, dateToInput, entityIdInput,
    entityTypeInput, requestIdInput,
  ]);
  ...
  return {
    ...
    actorEmailInput, setActorEmailInput,
    requestIdInput, setRequestIdInput,
    dateFromInput, setDateFromInput,
    dateToInput, setDateToInput,
    actorUserIdInput, setActorUserIdInput,
    entityTypeInput, setEntityTypeInput,
    entityIdInput, setEntityIdInput,
    advancedOpen, setAdvancedOpen,
    items, total, hasNext, loading, error,
    viewOpen, setViewOpen,
    selectedLog, setSelectedLog,
    totalPages, showingFrom, showingTo,
    last24hCount, failureCount,
    fetchAuditLogs, onApplyFilters, onResetFilters, onCopyRequestId,
  };
}
