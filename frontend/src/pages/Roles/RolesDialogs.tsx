        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={() => {
                if (assignConfirmRole) onConfirmAssign(assignConfirmRole);
              }}
            >
              Continue
            </AlertDialogAction>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {deleteRole
                ? `Type "${deleteRole.name}" to confirm deletion of role "${deleteRole.name}".`
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={!deleteRole || deleteConfirmText.trim() !== deleteRole.name || deleting}
